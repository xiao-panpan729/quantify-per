...
echo 14步数据采集 → gen_source_summary.py --ai
...
echo [2/11] 消息面突发事件检测（鼓掌WS + 东财 + 见闻）...
...
echo [3/11] US 市场异动提取（从快讯提取个股/板块/ETF异动）...
...
echo [4/11] 全球流动性全景（BTC/VIX/DXY/M2/社融）...
...
echo [5/11] 中国宏观快照（M2/SHIBOR/CPI/PMI + 国债利率/汇率/商品）...
...
echo [6/11] US宏观敏感度（Fed利率/CPI/PMI/非农）...
...
echo [8/11] 基本面数据层（Rolling FM / TypeAB / CAPEX）...
